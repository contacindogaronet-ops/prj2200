...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 🔴 KUNCI ARSITEKTUR: Memanggil XML Dashboard Utama (Menghapus Black Screen)
    ...
    // Algoritma Hooking: Mencari tombol "CHECK FOR UPDATES" lalu menyisipkan tombol Settings
                ...
                if (parent != null) {
                    for(int i=0; i<parent.getChildCount(); i++) {
                        ...
                        if(child instanceof Button && ((Button)child).getText().toString().contains("⚙️ CORE ENGINE SETTINGS")) {
                            return true; // Cegah duplikasi tombol
                        }
                    }
